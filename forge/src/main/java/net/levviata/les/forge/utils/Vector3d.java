package net.levviata.les.forge.utils;
...
public class Vector3d {
    ...
    public static Vector3d atCenterOf(Vector3f p_237489_0_) {
        return new Vector3d((double)p_237489_0_.x() + 0.5D, (double)p_237489_0_.y() + 0.5D, (double)p_237489_0_.z() + 0.5D);
    }

    public static Vector3d atLowerCornerOf(Vector3f p_237491_0_) {
        return new Vector3d((double)p_237491_0_.x(), (double)p_237491_0_.y(), (double)p_237491_0_.z());
    }

    public static Vector3d atBottomCenterOf(Vector3f p_237492_0_) {
        return new Vector3d((double)p_237492_0_.x() + 0.5D, (double)p_237492_0_.y(), (double)p_237492_0_.z() + 0.5D);
    }

    public static Vector3d upFromBottomCenterOf(Vector3f p_237490_0_, double p_237490_1_) {
        return new Vector3d((double)p_237490_0_.x() + 0.5D, (double)p_237490_0_.y() + p_237490_1_, (double)p_237490_0_.z() + 0.5D);
    }
    ...
    public Vector3d normalize() {
        double d0 = (double) Mth.sqrt(this.x * this.x + this.y * this.y + this.z * this.z);
    ...
    public Vector3d xRot(float p_178789_1_) {
        float f = Mth.cos(p_178789_1_);
        float f1 = Mth.sin(p_178789_1_);
        double d0 = this.x;
    ...
    public Vector3d yRot(float p_178785_1_) {
        float f = Mth.cos(p_178785_1_);
        float f1 = Mth.sin(p_178785_1_);
    ...
    public Vector3d zRot(float p_242988_1_) {
        float f = Mth.cos(p_242988_1_);
        float f1 = Mth.sin(p_242988_1_);
    ...
    @OnlyIn(Dist.CLIENT)
    public static Vector3d directionFromRotation(Vector3f p_189984_0_) {
    ...
    public static Vector3d directionFromRotation(float p_189986_0_, float p_189986_1_) {
        float f = Mth.cos(-p_189986_1_ * ((float)Math.PI / 180F) - (float)Math.PI);
        float f1 = Mth.sin(-p_189986_1_ * ((float)Math.PI / 180F) - (float)Math.PI);
        float f2 = -Mth.cos(-p_189986_0_ * ((float)Math.PI / 180F));
        float f3 = Mth.sin(-p_189986_0_ * ((float)Math.PI / 180F));
        return new Vector3d((double)(f1 * f2), (double)f3, (double)(f * f2));
    }

    public Vector3d align(EnumSet<Direction.Axis> p_197746_1_) {
        double d0 = p_197746_1_.contains(Direction.Axis.X) ? (double)Mth.floor(this.x) : this.x;
        double d1 = p_197746_1_.contains(Direction.Axis.Y) ? (double)Mth.floor(this.y) : this.y;
        double d2 = p_197746_1_.contains(Direction.Axis.Z) ? (double)Mth.floor(this.z) : this.z;
        return new Vector3d(d0, d1, d2);
    }
